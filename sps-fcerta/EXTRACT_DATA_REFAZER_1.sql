create or alter procedure EXTRACT_DATA_REFAZER_1
as
...
BEGIN
    ...
    BEGIN
        ...
        ORDER BY A2.NRRQU ASC, A2.CDFIL ASC;
    END
    ...
    BEGIN
        ...
        ORDER BY A3.NRRQU ASC, A3.CDFIL ASC;
    END
        FOR
            SELECT A1.CODIGO_PS AS CODIGO,
                    ...
                    '### VALOR BRUTO: R$ ' || CAST(A1.VRRQU AS NUMERIC(18,2)) || 
					          ...
					          ' ###' AS OBSERVACAO
                    FROM FC12000 A1
                      INNER JOIN FC12100 A2 ON A1.CODIGO_PS = A2.CODIGO_PS_A1
         ...
         FOR
            SELECT CODIGO_PS AS CODIGO,
                    ...
                    A2.TPFORMAFARMA AS CODIGO_FORMAFARMACEUTICA,
                    A2.VOLUME AS QVD,
